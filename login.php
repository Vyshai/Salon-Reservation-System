    ...
    if (empty(array_filter($error))) {
        ...
        if ($user) {
            ...
            if ($user['role'] == 'customer' && $user['is_verified'] == 0) {
                $submit_error = "Please verify your email before logging in. <a href='resend_verification.php?email=" . urlencode($email) . "'>Resend verification email</a>";
            } else {
...
<body>
    ...
    <div style="background: #fff3cd; color: #856404; padding: 15px; text-align: center; margin: 20px;">
