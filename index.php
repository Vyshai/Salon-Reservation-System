        ...
        <div class="header-container">
            ...
            <div class="nav-links">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <a href="myOrders.php">My Orders</a>  <!-- CHANGED -->
                    <a href="createOrder.php">New Order</a>  <!-- ADDED -->
                ...
                <?php foreach ($services as $service): ?>
                    <div class="service-card">
                        ...
                        if (isset($_SESSION['user_id'])) {
                            ...
                            $userCheck = new User();
                            $user = $userCheck->getUserById($_SESSION['user_id']);
                            
                            if ($user && ($user['role'] != 'customer' || $user['is_verified'] == 1)) {
                                // User is verified or is admin/staff
                                echo '<a href="createOrder.php" class="book-btn">Order Now</a>';
                            } else {
                                // User not verified
                                echo '<a href="verifyEmail.php" class="book-btn" style="background: #ffc107; color: #000;">Verify Email First</a>';
                            }
                        } else {
